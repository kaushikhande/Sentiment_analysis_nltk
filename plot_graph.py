...
def plot_learning_curve(estimator, title, X, y, ylim=None, cv=None,
    ...
    train_sizes2, train_scores2, test_scores2 = learning_curve(
        svm.SVC(), X, y, cv=cv, n_jobs=n_jobs, train_sizes=train_sizes)
    ...
    plt.fill_between(train_sizes1, test_scores_mean1 - test_scores_std1,
                     test_scores_mean1 + test_scores_std1, alpha=0.1, color="y")
    ...
    plt.plot(train_sizes, test_scores_mean, 'o-', color="g",
             label="CV svm.SVC(kernel='linear')")
    ...
    plt.plot(train_sizes2, test_scores_mean2, 'o-', color="b",
             label="CV svm.SVC()")
    plt.legend(loc="best")
    return plt
