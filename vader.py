...
"VADER is smart, handsome, and funny!", # punctuation emphasis handled correctly (sentiment intensity adjusted)"VADER is very smart, handsome, and funny.",  # booster words handled correctly (sentiment intensity adjusted)
...
"Most automated sentiment analysis tools are good.",
"Most automated sentiment analysis tools are bad.",
