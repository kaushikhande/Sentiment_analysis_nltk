...
def add_neg(i,word):
    ...
    for m in range(index,length_of_sentence):
        str = i[m] + '_neg'
        i[m] = str
...
def evaluate_features(feature_select):
	...
	for i, (features, label) in enumerate(testFeatures):
		...
		#print referenceSets[label].add(i)
		#raw_input('>>>zz')
		predicted = classifier.classify(features)
		testSets[predicted].add(i)
		
		#print referenceSets.items()
		#print referenceSets.keys()
		#print referenceSets.viewitems()
		#print referenceSets.viewvalues()
		#print referenceSets.values()
		
		#print referenceSets['pos']
		##print testSets['pos']
